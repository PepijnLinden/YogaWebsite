<?php
/**
 * Solid Construction Theme Options Sanitization Functions
 *
 ...
 */
function solid_construction_sanitize_select( $input, $setting ) {
 ...
 */
function solid_construction_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function solid_construction_sanitize_post( $input ) {
 ...
 */
function solid_construction_sanitize_image( $image, $setting ) {
    /*
 ...
 *                    the setting default.
 */
function solid_construction_sanitize_number_range( $number, $setting ) {
